...
Investigar a arquitetura de geração de valor da empresa — como ela transforma insumos em caixa livre recorrente. Permite:
...
Dados do último ITR: estoques, contas a receber (CR), contas a pagar (CP), receita anualizada.
...
[ preencher eventos-chave: M&A, desinvestimentos, expansões, mudanças regulatórias ]
...
| Critério | Valor Atual | Valor Esperado | Implicação Técnica |
|----------|-------------|----------------|--------------------|
...
| Antifragilidade ao ciclo macro | | | |
| **Média** | | | **Análise final** |
